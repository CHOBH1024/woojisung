import { r as rootRouteId, i as invariant, t as trimPathLeft, j as joinPaths, a as trimPathRight, b as redirect, R as React, c as reactExports, d as dummyMatchContext, m as matchContext, u as useRouterState, e as useRouter, f as requireReactDom, g as isDangerousProtocol, h as exactPathTest, k as removeTrailingSlash, l as deepEqual, n as functionalUpdate, o as React__default, p as jsxRuntimeExports, q as isModuleNotFoundError, s as RouterCore, v as useHydrated, w as escapeHtml, O as Outlet } from "./worker-entry-CekZxYvN.js";
import "node:events";
...
const appCss = "/woojisung/assets/styles-usC0_Xn5.css";
...
const Route$3 = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Make It Mine 35 — 미래형 역량 진단 솔루션" },
      { name: "description", content: "Make It Mine 35는 개인의 잠재력을 데이터로 증명하는 차세대 역량 분석 플랫폼입니다." },
      { name: "theme-color", content: "#1e3a8a" },
      { property: "og:title", content: "Make It Mine 35" },
      { property: "og:description", content: "당신의 핵심 역량을 발견하고 커리어의 지도를 완성하세요." },
...
function RootComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-[#f8fafc] flex flex-col lg:flex-row", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("aside", { className: "hidden lg:flex w-64 bg-slate-50 border-r border-slate-200 p-4 items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full h-[600px] bg-white border-2 border-dashed border-slate-200 rounded-2xl flex items-center justify-center text-slate-400 text-sm font-bold text-center px-6 shadow-sm", children: [
      "ADVERTISEMENT",
      /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
      "(Premium Slot)"
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 relative overflow-x-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("aside", { className: "hidden lg:flex w-64 bg-slate-50 border-l border-slate-200 p-4 items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full h-[600px] bg-white border-2 border-dashed border-slate-200 rounded-2xl flex items-center justify-center text-slate-400 text-sm font-bold text-center px-6 shadow-sm", children: [
      "ADVERTISEMENT",
      /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
      "(Premium Slot)"
    ] }) })
...
const $$splitComponentImporter$2 = () => import("./terms-Df8cJYCj.js");
const Route$2 = createFileRoute("/terms")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./privacy-C6BJdfiS.js");
const Route$1 = createFileRoute("/privacy")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-DCv__9Nn.js").then((n) => n.i);
const Route2 = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter, "component"),
  head: () => ({
    meta: [{
      title: "조직 인재 아키타입 진단 | Professional Organization Archetype"
    }, {
      name: "description",
      content: "에니어그램, Big 5, 커리어 앵커, VIA 강점 및 EQ를 통합한 AI 기반 조직 구성원 성향 및 역량 분석 도구"
    }]
  })
});
